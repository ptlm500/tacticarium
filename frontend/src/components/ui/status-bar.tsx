...
export function StatusBar({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="flex items-center gap-4 text-foreground/80">{leftContent}</div>
      <div className="flex items-center gap-4 text-foreground/80">{rightContent}</div>
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between border-b border-border/50 bg-muted/30 px-4 py-2">
        ...
        {timestamp && <span className="font-mono text-[10px] text-foreground/80">{timestamp}</span>}
      </div>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <span className="uppercase tracking-widest text-cyan-500">UPLINK: {channel}</span>
      </div>

      <div className="flex items-center gap-4">
        {status && <span className="uppercase tracking-widest text-foreground/80">{status}</span>}
