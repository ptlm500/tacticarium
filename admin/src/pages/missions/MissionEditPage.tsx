              ...
              <div className="grid grid-cols-2 gap-2 mb-2">
                ...
                <div>
                  ...
                  <input
                    type="number"
                    value={rule.vp}
                    onChange={(e) => updateRule(i, "vp", parseInt(e.target.value) || 0)}
                    className="w-full px-2 py-1 bg-gray-700 border border-gray-600 rounded text-xs"
                  />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-2 mb-2">
                <div>
                  ...
                  <input
                    ...
                    min={0}
                    max={5}
                    value={rule.minRound || 0}
                    onChange={(e) => updateRule(i, "minRound", parseInt(e.target.value) || 0)}
                    className="w-full px-2 py-1 bg-gray-700 border border-gray-600 rounded text-xs"
                  />
                </div>
                <div>
                  <label className="block text-xs text-gray-500 mb-1">
                    Scoring Timing Override
                  </label>
                  <input
                    type="text"
                    value={rule.scoringTiming || ""}
                    onChange={(e) => updateRule(i, "scoringTiming", e.target.value)}
                    placeholder="(uses mission default)"
                    className="w-full px-2 py-1 bg-gray-700 border border-gray-600 rounded text-xs"
                  />
                </div>
              </div>
